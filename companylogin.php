 ...
 {
 header('Location: company/companyprofile.php');
 exit();
 } ?>
        ...
        <div class="animate form login_form">
          ...
          <section class="login_content">
            <form role="form" method="post" action="companycheck.php">
             ...
             <div>
              <input size=\"20\" type="text" size="20" class="form-control" maxlength="30" placeholder="Company Email" name="email" autofocus>
        ...
        <div id="register" class="animate form registration_form">
          <section class="login_content">
            <form role="form" action= "addcompany.php" method="post">
              ...
              <div>
                <input size=\"20\" type="text" size="20" class="form-control" maxlength="30" placeholder="companyname" name="companyname" autofocus>
              ...
              <div>
                <input size=\"20\" type="password" size="20" class="form-control" maxlength="30" placeholder="Password" >
                <!-- <input type="password" class="form-control" placeholder="Password" required="" />-->
              </div>
              <div>
                <input size=\"20\" type="password" size="20" class="form-control" maxlength="30" placeholder="Confirm Password" name="password">
                <!-- <input type="password" class="form-control" placeholder="Password" required="" />-->
              </div>
              <div>
